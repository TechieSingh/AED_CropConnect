...
public class SelectMarketJPanel extends javax.swing.JPanel {
    ...
    SelectMarketJPanel(JPanel processControlStack, DistributorAdmin distributorAdmin, MarketDirectory marketDirectory, CropDirectory cropDirectory, FmcgTransactionDirectory fmcgTransactionDirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnRequirement.setText("List Procurement Order");
    ...
    private void btnRequirementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequirementActionPerformed
        ...
        ProcurementOrderJPanel procurementOrderJPanel = new ProcurementOrderJPanel(processStackjPanel, distributorAdmin, marketDirectory.searchMarkets(marketName), crop1, fmcgTransactionDirectory);
        processStackjPanel.add("ProcurementOrderJPanel",procurementOrderJPanel);
        CardLayout layout = (CardLayout) processStackjPanel.getLayout();
